...
public class SAXParserTest {
    ...
    public void SAXParserTest() throws ParserConfigurationException, SAXException, IOException {
        ...
        SAXPaperHandler handler = new SAXPaperHandler();

        parser.parse(ClassLoader.getSystemResourceAsStream("papers.xml"), handler);
        List<Paper> actualList = handler.getPaperList();
